...
<p align="center">
  <img src="https://img.shields.io/badge/Unity-2026%2B-000000?style=for-the-badge&logo=unity&logoColor=white" />
...
```mermaid
flowchart LR
    A([STEP 1<br/>월드 구축<br/>캐릭터 컨트롤]) --> B([STEP 2<br/>캐릭터 상태<br/>정보 시스템])
    B --> C([STEP 3<br/>멀티플레이<br/>행동 동기화])
    C --> D([STEP 4<br/>아이템 &<br/>레이캐스트])
    D --> E([STEP 5<br/>오브젝트<br/>상호작용])
    E --> F([STEP 6<br/>AI 시스템<br/>NPC & Mobs])
    style A fill:#7C3AED,stroke:#fff,color:#fff
    style B fill:#8B5CF6,stroke:#fff,color:#fff
    style C fill:#A78BFA,stroke:#fff,color:#fff
    style D fill:#C4B5FD,stroke:#fff,color:#000
    style E fill:#DDD6FE,stroke:#fff,color:#000
    style F fill:#EDE9FE,stroke:#fff,color:#000
```

<details>
<summary><b>커리큘럼 상세 보기 (클릭)</b></summary>
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=unity,cs,git,github,visualstudio,blender&theme=dark" />
</p>

<p align="center">
  <sub><b>Unity Engine</b> · <b>C#</b> · <b>Git/GitHub</b> · <b>Visual Studio</b> · <b>Blender</b></sub>
</p>
...
<p align="center">
  <sub><b>Owl Games</b> · Made with by SOWL · 성공회대학교 IT동아리</sub>
</p>
